...
**Dependência operacional:** só habilitar esta melhoria após integrar PR #19 e executar o smoke test de publicação real de #21. A implementação e os testes da issue #23 podem ser revisados antes disso, mas o comportamento de leitura de PR pendente no ambiente definitivo ainda depende dessa validação.
